...
impl SpriteRenderer {
    ...
    pub fn render_line(&self, vram: &[u8], line: u8, sprite_size: u8, 
                      obp0: u8, obp1: u8) -> [Option<u8>; SCREEN_WIDTH] {
        ...
        for sprite in &self.visible_sprites {
            ...
            let flipped_y = if sprite.is_y_flipped() {
                if sprite_size != 0 { 15 - sprite_line } else { 7 - sprite_line }
            } else {
                sprite_line
            };
